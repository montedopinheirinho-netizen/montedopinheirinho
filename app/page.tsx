    ...
    <div className="flex flex-col w-full bg-white text-[#112535]">
      ...
      <section className="relative h-screen w-full flex items-end pb-24 justify-center">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/reservas" className="px-8 py-4 bg-white text-[#112535] text-xs font-medium tracking-[0.2em] uppercase hover:bg-stone-100 transition-colors">
              Reservar Estadia
            </Link>
      ...
      <section className="py-24 px-6 bg-[#112535] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            ...
            <div className="bg-white/5 p-8 border border-white/10 flex flex-col justify-between">
              <p className="font-light italic text-white/90 leading-relaxed mb-6">
                &ldquo;Très calme, bel environnement, des hôtes attentionnés avec un petit panier d&apos;accueil à l&apos;arrivée, une grande maison bien équipée et propre.&rdquo;
              </p>
              <div className="text-xs tracking-widest uppercase text-white/60">
      ...
      <section className="py-20 px-6 bg-stone-50 text-center border-t border-stone-200">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/reservas" className="px-10 py-4 bg-[#112535] text-white text-xs font-medium tracking-[0.2em] uppercase hover:opacity-90 transition-opacity">
              Fazer Pedido de Reserva
            </Link>
            <Link href="/contactos" className="px-10 py-4 border border-[#112535] text-[#112535] text-xs font-medium tracking-[0.2em] uppercase hover:bg-[#112535] hover:text-white transition-colors">
              Fale Connosco
            </Link>
          </div>
        </div>
